...
Mousetrap.bind('d o space a space b a r r e l space r o l l', function () {
    document.getElementById("wrapper").classList.add('fa-spin');

    setTimeout(hi, 2000);
});
function hi() {
     document.getElementById("wrapper").classList.remove('fa-spin');
}